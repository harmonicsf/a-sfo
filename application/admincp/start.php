...
// Next Step
if($controller) require(APP.'admincp/controller/'.$controller.'.php');
if($is_mobile)  require(APP.'admincp/view/'.$theme.'/'.$view.'.php');
else            require(APP.'admincp/view/'.$theme.'/'.$view.'.php');
